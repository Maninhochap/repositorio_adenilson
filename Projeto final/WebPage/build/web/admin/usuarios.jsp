<%-- 
    Document   : usuarios
    Created on : 26 de nov. de 2022, 17:57:56
    Author     : vanes
--%>
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            ...
                                            <form action="./config/editarUsuario.jsp?id=<% out.print(id);%>" method="POST">
                                              <div class="modal-body">
                                                  <div class="mb-3">
                                                    <label for="name" class="form-label">Nome</label>
                                                    <input type="text" name="nome" value="<%=rs.getString(2)%>" class="form-control" placeholder="Informe o nome">
                                                  </div>
                                                  <div class="mb-3">
                                                    <label for="email" class="form-label">Email</label>
                                                    <input type="email" name="email" value="<%=rs.getString(3)%>" class="form-control"  placeholder="name@example.coom">
                                                  </div>
                                                  <div class="mb-3">
                                                    <label for="telefone" class="form-label">Telefone</label>
                                                    <input type="text" name="telefone" value="<%=rs.getString(4)%>" class="form-control"  placeholder="Telefone (00)0000-0000">
                                                  </div>
                                                  <div class="mb-3">
                                                    <label for="senha" class="form-label">Senha</label>
                                                    <input type="password" name="senha" value="<%=rs.getString(5)%>" class="form-control"  placeholder="Crie uma senha">
                                                  </div>
        ...
        <%
            if(request.getParameter("funcao")!= null && request.getParameter("funcao").equals("excluir")){
                ...
                try{
                    ...
                    response.sendRedirect("usuarios.jsp?erro=2");
                }catch(Exception e){
                out.println(e);
                }
            }
